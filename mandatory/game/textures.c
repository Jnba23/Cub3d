...
/*   Updated: 2025/02/24 11:26:10 by hmoukit          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	printf("wall_x === %f, tex_x === %d\n", game->text->wall_x, game->text->tex_x);
